...
class WPEC_QV_ColorBox_Popup_Settings extends WPEC_QV_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Color Box Pop Up Settings successfully saved.', 'wp-e-commerce-products-quick-view' ),
				'error_message'		=> __( 'Error: Color Box Pop Up Settings can not save.', 'wp-e-commerce-products-quick-view' ),
				'reset_message'		=> __( 'Color Box Pop Up Settings successfully reseted.', 'wp-e-commerce-products-quick-view' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'label'				=> __( 'Color Box Pop Up', 'wp-e-commerce-products-quick-view' ),
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
            	'name' 		=> __( 'Colour Box Pop Up', 'wp-e-commerce-products-quick-view' ),
                'type' 		=> 'heading',
           	),
			array(  
			...
			array(  
				'name' 		=> __( 'Open & Close Transition Effect', 'wp-e-commerce-products-quick-view' ),
				'desc' 		=> __( "Choose a pop-up opening & closing effect. Default - None", 'wp-e-commerce-products-quick-view' ),
			...
			array(  
				'name' 		=> __( 'Opening & Closing Speed', 'wp-e-commerce-products-quick-view' ),
				'desc' 		=> __( 'Milliseconds when open and close popup', 'wp-e-commerce-products-quick-view' ),
