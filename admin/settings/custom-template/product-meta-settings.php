...
class WPEC_QV_Custom_Template_Product_Meta_Settings extends WPEC_QV_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Product Meta Settings successfully saved.', 'wp-e-commerce-products-quick-view' ),
				'error_message'		=> __( 'Error: Product Meta Settings can not save.', 'wp-e-commerce-products-quick-view' ),
				'reset_message'		=> __( 'Product Meta Settings successfully reseted.', 'wp-e-commerce-products-quick-view' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			'name'				=> 'product-meta',
			'label'				=> __( 'Product Meta', 'wp-e-commerce-products-quick-view' ),
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
				'name'		=> __( 'Product Meta Setup', 'wp-e-commerce-products-quick-view' ),
                'type' 		=> 'heading',
           	),
			array(  
				'name' 		=> __( 'Product Meta', 'wp-e-commerce-products-quick-view' ),
			...
			array(
				'name'		=> __( 'Product Meta Style', 'wp-e-commerce-products-quick-view' ),
                'type' 		=> 'heading',
				'class'		=> 'show_product_meta_container'
           	),
			array(  
				'name' 		=> __( 'Product Meta Alignment', 'wp-e-commerce-products-quick-view' ),
				'id' 		=> 'meta_alignment',
				'type' 		=> 'onoff_radio',
				'default' 	=> 'left',
				'onoff_options' => array(
			...
			array(  
				'name' 		=> __( 'Product Meta Name Font', 'wp-e-commerce-products-quick-view' ),
				'id' 		=> 'meta_name_font',
				'type' 		=> 'typography',
				'default'	=> array( 'size' => '12px', 'face' => 'Arial, sans-serif', 'style' => 'normal', 'color' => '#000000' )
			),
			array(  
				'name' 		=> __( 'Product Meta Value Font', 'wp-e-commerce-products-quick-view' ),
				'id' 		=> 'meta_value_font',
				'type' 		=> 'typography',
				'default'	=> array( 'size' => '12px', 'face' => 'Arial, sans-serif', 'style' => 'normal', 'color' => '#000000' )
			),
			array(  
				'name' 		=> __( 'Product Meta Value Hover Color', 'wp-e-commerce-products-quick-view' ),
				'id' 		=> 'meta_value_font_hover_color',
				'type' 		=> 'color',
				'default'	=> '#999999'
			),
			array(  
				'name' 		=> __( 'Product Meta Margin', 'wp-e-commerce-products-quick-view' ),
				'id' 		=> 'meta_margin',
