...
class WPEC_QV_Custom_Template_Product_Price_Settings extends WPEC_QV_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Product Price Settings successfully saved.', 'wp-e-commerce-products-quick-view' ),
				'error_message'		=> __( 'Error: Product Price Settings can not save.', 'wp-e-commerce-products-quick-view' ),
				'reset_message'		=> __( 'Product Price Settings successfully reseted.', 'wp-e-commerce-products-quick-view' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			'name'				=> 'product-price',
			'label'				=> __( 'Product Price', 'wp-e-commerce-products-quick-view' ),
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
				'name'		=> __( 'Product Price Setup', 'wp-e-commerce-products-quick-view' ),
                'type' 		=> 'heading',
           	),
			array(  
				'name' 		=> __( 'Product Price', 'wp-e-commerce-products-quick-view' ),
			...
			array(
				'name'		=> __( 'Product Price Style', 'wp-e-commerce-products-quick-view' ),
                'type' 		=> 'heading',
				'class'		=> 'show_product_price_container'
           	),
			array(  
				'name' 		=> __( 'Price Font', 'wp-e-commerce-products-quick-view' ),
				'id' 		=> 'price_font',
				'type' 		=> 'typography',
				'default'	=> array( 'size' => '12px', 'face' => 'Arial, sans-serif', 'style' => 'normal', 'color' => '#FF0000' )
			),
			array(  
				'name' 		=> __( 'Old Price Font', 'wp-e-commerce-products-quick-view' ),
				'id' 		=> 'old_price_font',
				'type' 		=> 'typography',
				'default'	=> array( 'size' => '11px', 'face' => 'Arial, sans-serif', 'style' => 'normal', 'color' => '#000000' )
			),
			array(  
				'name' 		=> __( 'Price Alignment', 'wp-e-commerce-products-quick-view' ),
				'id' 		=> 'price_alignment',
				'type' 		=> 'onoff_radio',
				'default' 	=> 'left',
				'onoff_options' => array(
			...
			array(  
				'name' 		=> __( 'Price Margin', 'wp-e-commerce-products-quick-view' ),
				'id' 		=> 'price_margin',
