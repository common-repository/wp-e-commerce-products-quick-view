...
class WPEC_QV_Custom_Template_Product_Rating_Settings extends WPEC_QV_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Product Rating Settings successfully saved.', 'wp-e-commerce-products-quick-view' ),
				'error_message'		=> __( 'Error: Product Rating Settings can not save.', 'wp-e-commerce-products-quick-view' ),
				'reset_message'		=> __( 'Product Rating Settings successfully reseted.', 'wp-e-commerce-products-quick-view' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			'name'				=> 'product-rating',
			'label'				=> __( 'Product Rating', 'wp-e-commerce-products-quick-view' ),
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
				'name'		=> __( 'Product Rating Setup', 'wp-e-commerce-products-quick-view' ),
                'type' 		=> 'heading',
           	),
			array(  
				'name' 		=> __( 'Product Rating', 'wp-e-commerce-products-quick-view' ),
				'id' 		=> 'show_rating',
				'class'		=> 'show_rating',
				'type' 		=> 'onoff_checkbox',
				'default'	=> 1,
			...
			array(
				'name'		=> __( 'Product Rating Style', 'wp-e-commerce-products-quick-view' ),
                'type' 		=> 'heading',
				'class'		=> 'show_rating_container'
           	),
			array(  
				'name' 		=> __( 'Rating Alignment', 'wp-e-commerce-products-quick-view' ),
				'id' 		=> 'rating_alignment',
				'type' 		=> 'onoff_radio',
				'default' 	=> 'left',
				'onoff_options' => array(
			...
			array(  
				'name' 		=> __( 'Rating Margin', 'wp-e-commerce-products-quick-view' ),
				'id' 		=> 'rating_margin',
