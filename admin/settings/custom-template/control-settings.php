...
class WPEC_QV_Custom_Template_Control_Settings extends WPEC_QV_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Controls Settings successfully saved.', 'wp-e-commerce-products-quick-view' ),
				'error_message'		=> __( 'Error: Controls Settings can not save.', 'wp-e-commerce-products-quick-view' ),
				'reset_message'		=> __( 'Controls Settings successfully reseted.', 'wp-e-commerce-products-quick-view' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			'name'				=> 'control',
			'label'				=> __( 'Controls', 'wp-e-commerce-products-quick-view' ),
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
				'name'		=> __( 'Controls Settings', 'wp-e-commerce-products-quick-view' ),
                'type' 		=> 'heading',
           	),
			array(  
				'name' 		=> __( 'Next / Previous Control', 'wp-e-commerce-products-quick-view' ),
				'id' 		=> 'enable_control',
			...
			array(  
				'name' 		=> __( 'Control Transition', 'wp-e-commerce-products-quick-view' ),
				...
				'onoff_options' => array(
					array(
						'val' 				=> 'alway',
						'text' 				=> __( 'Alway show when popup loaded', 'wp-e-commerce-products-quick-view' ),
						'checked_label'		=> __( 'ON', 'wp-e-commerce-products-quick-view' ) ,
						'unchecked_label' 	=> __( 'OFF', 'wp-e-commerce-products-quick-view' ) ,
					),
					array(
						'val' 				=> 'hover',
						'text' 				=> __( 'Show when hover on popup container', 'wp-e-commerce-products-quick-view' ),
						'checked_label'		=> __( 'ON', 'wp-e-commerce-products-quick-view' ) ,
						'unchecked_label' 	=> __( 'OFF', 'wp-e-commerce-products-quick-view' ) ,
					),
				),			
			...
			array(  
				'name' 		=> __( 'Previous Icon', 'wp-e-commerce-products-quick-view' ),
				'id' 		=> 'control_previous_icon',
				'type' 		=> 'upload',
				'default'	=> WPEC_QV_ULTIMATE_IMAGES_URL.'/playback-prev.png',
			),
			array(  
				'name' 		=> __( 'Next Icon', 'wp-e-commerce-products-quick-view' ),
