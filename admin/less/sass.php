...
class WPEC_QV_Less
{
	...
	public $css_file_name = 'wpec_quick_view_ultimate';
    public $button_css_file_name = 'wpec_quick_view_button';
	...
	public function plugin_build_sass()
    {
        ...
        $sass_button = $this->sass_button_content_data();
        $this->plugin_compile_less_mincss( $sass_button, $this->button_css_file_name );
    ...
    public function sass_button_content_data()
    {
        do_action($this->plugin_name . '_get_all_settings');
